 	...
 	<div style="height:600px;">
		...
		<div class="ad_right" style="width:68%;height:95%;float:right;">
			<table class="table table-hover">
			   <caption>管理课程------><a href="admin/addcourse">增加课程</caption></a>
			   <thead>
			      <tr>
			         <th>课程号</th>
			         <th>课程名</th>
			   ...
			   <tbody>
			   	   <c:forEach  items="${coulist }" var="t">
				      <tr>
				         <td>${t.cno }</td>
				         <td>${t.cname }</td>
				         <td>${t.cimage }</td>
				         <td>
				         	<a href="admin/updcourse?cno=${t.cno }"><button>修改</button></a>
				         	<a href="admin/delcourse?cno=${t.cno }"><button>删除</button></a>
				         </td>
				      </tr>
				   </c:forEach>
			   </tbody>
