 	...
 	<div style="height:600px;">
		...
		<div class="ad_right" style="width:68%;height:95%;float:right;">
			<table class="table table-hover" style="width:100%;">
			   <caption>管理老师------><a href="admin/addteacher">添加老师</a></caption>
			   <thead>
			      <tr>
			         <th>帐号</th>
			         <th>姓名</th>
			   ...
			   <tbody>
				      ...
				      <tr>
				         ...
				         <td>${t.timage }</td>
				         <td>
				         	<a href="admin/updteacher?tno=${t.tno }"><button>修改</button></a>
				         	<a href="admin/delteacher?tno=${t.tno }"><button>删除</button></a>
				         </td>
				      </tr>
				   </c:forEach>
			   </tbody>
