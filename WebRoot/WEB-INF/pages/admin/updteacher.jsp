...
<div class="wrapper">
 	<div style="height:600px;">
		...
		<div class="ad_right" style="width:68%;height:95%;float:right;">
			...
			<div style="border:2px solid #dbdbdb;height:200px;">
				<form method="post" action="admin/updteacher?tno=${tea.tno }" enctype="multipart/form-data" >
					<div style="width:20%;float:left;">
						<p style="margin:16px;">帐号</p>					
						<p style="margin:16px;">姓名</p>					
						<p style="margin:16px;">密码</p>					
						<p style="margin:16px;">签名</p>
						<input type="submit" value="确认修改" style="margin-left:10px;">
					</div>
					<div style="width:50%;float:left;">
						<input type="text" name="_tno" value="${tea.tno }" style="margin-top:10px;"><br/>
						<input type="text" name="_tname" value="${tea.tname }" style="margin-top:10px;"><br/>
						<input type="text" name="_tpwd" value="${tea.tpwd }" style="margin-top:10px;"><br/>
						<input type="file" name="timage" style="margin-top:10px;">
					</div>
					<div style="float:left;width:30%;">
					  	<p>现有签名</p>
					  	<img src="./images/${tea.timage } " >
					</div>
				</form>
			</div>
		</div>
