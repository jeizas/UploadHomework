...
<div class="wrapper">
 	<div style="height:600px;">
		...
		<div class="ad_right" style="width:68%;height:95%;float:right;">
			...
			<div style="border:2px solid #dbdbdb;height:280px;">
				<form method="post" action="admin/updstudent?sno=${stu.sno }" enctype="multipart/form-data" >
					...
					<div style="width:50%;float:left;">
						<input type="text" value="${stu.sno }" style="margin-top:10px;"><br/>
						<input type="text" name="sname" value="${stu.sname }" style="margin-top:10px;"><br/>
						<input type="text" name="spwd" value="${stu.spwd }" style="margin-top:10px;"><br/>
						<input type="text" name="smajor" value="${stu.smajor }" style="margin-top:10px;"><br/>
						<input type="text" name="sgrade" value="${stu.sgrade }" style="margin-top:10px;"><br/>
						<input type="text" name="sclass" value="${stu.sclass }" style="margin-top:10px;"><br/>
					</div>
				</form>
			</div>
		</div>
