 	...
 	<div style="height:600px;">
		...
		<div class="ad_right" style="width:68%;height:95%;float:right;">
			<table class="table table-hover">
			   <caption>管理学生------><a href="admin/addstudent">添加学生</a></caption>
			   <thead>
			      <tr>
			         <th>学号</th>
			         <th>姓名</th>
			   ...
			   <tbody>
				      ...
				      <tr>
				         ...
				         <td>${t.sclass }班</td>
				         <td>
				         	<a href="admin/updstudent?sno=${t.sno }"><button>修改</button></a>
				         	<a href="admin/delstudent?sno=${t.sno }"><button>删除</button></a>
				         </td>
				      </tr>
				   </c:forEach>
			   </tbody>
