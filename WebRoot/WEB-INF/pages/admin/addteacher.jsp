 	...
 	<div style="height:600px;">
		...
		<div class="ad_right" style="width:68%;height:95%;float:right;">
			...
			<div style="border:2px solid #dbdbdb;height:200px;">
				<form method="post" action="admin/addteacher" enctype="multipart/form-data" >
					...
					<div style="width:50%;float:left;">
						<input type="text" name="tno"  style="margin-top:10px;"><br/>
						<input type="text" name="tname"  style="margin-top:10px;"><br/>
						<input type="password" name="tpwd" value="000000" style="margin-top:10px;"><br/>
						<input type="file" name="timage" style="margin-top:10px;" onchange="judgeImage(this);">
					</div>
				</form>
			</div>
		</div>
