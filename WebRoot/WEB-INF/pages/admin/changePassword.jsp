...
<div class="wrapper">
 	<div style="height:600px;">
		...
		<div class="ad_right" style="width:68%;height:95%;float:right;">
			...
			<form method="post" action="admin/changePassword?id=${id }" name="modifyForm"  >
					...
					<div style="width:50%;float:left;">
						...
						<input type="text" name="_apwd"  id="_apwd" style="margin-top:10px;"><br/>
						<input type="text"  name="apwd"  id="apwd"  style="margin-top:10px;"><br/>
					</div>
			</form>
		</div>
	</div>	
