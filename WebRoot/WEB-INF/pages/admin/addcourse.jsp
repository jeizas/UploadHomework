			...
			<div style="border:2px solid #dbdbdb;height:200px;">
				<form method="post" action="admin/addteacher" enctype="multipart/form-data" >
					<div style="width:20%;float:left;">
						...
						<p style="margin:16px;">课程简介</p>
						<input type="submit" value="添加" style="margin-left:10px;"/>
					</div>
					<div style="width:60%;float:left;">
						<input type="text" name="cno"  style="margin-top:10px;"><br/>
						<input type="text" name="cname"  style="margin-top:10px;"><br/>
						<input type="file" name="cimage" style="margin-top:10px;">
						<textarea rows="3" cols="30" name="csummary" style="margin-top:10px;"> 
