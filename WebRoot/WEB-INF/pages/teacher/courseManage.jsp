		  ...
		  <div class="header">
			...
			<div class="cssmenu">
			  <ul>
		  		...
		  		<li class="active"><a href="javascript:void(0)"><span>课程管理</span></a></li>
					...
					<div class="ser-para">
						...
						<c:forEach items="${courseList }" var="cou">
							<div class="ser-grid-list img_style">
								<h5>${cou.cname }</h5>
								<a href="teacher/lookHomework/${cou.cno }"><img src="./images/${cou.cimage }" alt=""></a>
								<p class="para" id="para-button">${cou.csummary }</p>
								<div class="read_more">
									<a href="teacher/lookHomework/${cou.cno }"><button class="btn">进入课程</button></a>
								</div>
							</div>
						</c:forEach>				
					<div class="clear"></div>
