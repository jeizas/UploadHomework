...
function HS_calender(){
	...
	style +=".calender { width:170px; height:160px; font-size:12px; margin-right:14px; background:url() no-repeat right center #fff; border:1px solid #397EAE; padding:1px}";
